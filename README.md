...
1. Learn Segregation: Educating users on proper waste segregation practices. 
2. Interactive Quizzes: Engaging users to test and improve their knowledge of waste management. 
3. AI-Powered Chatbot: Offering instant assistance and guidance to users. 
4. Image Prediction: Using AI to identify types of waste through image classification. 
5. Waste Category Identification: Assisting users in classifying waste into biodegradable, recyclable, or hazardous categories. 
